...
build-supabase: docker-supabase
...
build-api: docker-api ## Build the leapfrogai_api container and Zarf package
...
build-ui: docker-ui ## Build the leapfrogai_ui container and Zarf package
