...
const (
	ChatCompletionService_ChatComplete_FullMethodName = "/chat.ChatCompletionService/ChatComplete"
)
...
func (c *chatCompletionServiceClient) ChatComplete(ctx context.Context, in *ChatCompletionRequest, opts ...grpc.CallOption) (*ChatCompletionResponse, error) {
	...
	err := c.cc.Invoke(ctx, ChatCompletionService_ChatComplete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ChatCompletionService_ChatComplete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatCompletionService_ChatComplete_FullMethodName,
	}
...
const (
	ChatCompletionStreamService_ChatCompleteStream_FullMethodName = "/chat.ChatCompletionStreamService/ChatCompleteStream"
)
...
func (c *chatCompletionStreamServiceClient) ChatCompleteStream(ctx context.Context, in *ChatCompletionRequest, opts ...grpc.CallOption) (ChatCompletionStreamService_ChatCompleteStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChatCompletionStreamService_ServiceDesc.Streams[0], ChatCompletionStreamService_ChatCompleteStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
