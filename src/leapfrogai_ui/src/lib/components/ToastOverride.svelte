<!--This is copy/pasted from flowbite-svelte except for a minor bug fix for icon color reactivity.
We have a PR open for this, once merged, we can delete this file and switch back to flowbite-svelte's Toast
https://github.com/themesberg/flowbite-svelte/pull/1422
-->
...
<script lang="ts">
  ...
  import { CloseButton, type ColorVariant, type ToastPositionType } from 'flowbite-svelte';

  // Type copied from flowbite-svelte, and this is a temporary component until upstream PR merged
