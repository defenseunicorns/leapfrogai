<!--There is a bug in Flowbite's Radio component that we submitted
a PR for here: https://github.com/themesberg/flowbite-svelte/pull/1398
This is a copy-paste of their component with that change until they patch it
-->
...
<input
  ...
  {value}
  {...$$restProps}
  class={inputClass(custom, color, false, background, spacing, $$slots.default || $$props.class)}
/>
<!--
@component
