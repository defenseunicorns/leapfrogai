...
create table profiles (
    ...
    @@ -26,59 +27,31 @@ create table profiles (
...
@@ -92,6 +65,51 @@ create policy "Users can insert their own profile." on profiles
...
@@ -102,22 +120,26 @@ update using ((metadata ->> 'created_by') = auth.uid()::text);
...
(storage.objects(name))[1] = (select auth.uid()::text)
);