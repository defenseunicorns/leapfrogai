...
from leapfrogai_sdk import AudioRequest
...
class AudioServicer(object):
    ...
    async def Translate(self, request_iterator: AsyncIterator[AudioRequest], context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")

    async def Transcribe(self, request_iterator: AsyncIterator[AudioRequest], context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
