...
from leapfrogai_api.types.audio import audio_pb2_grpc
from leapfrogai_api.types.chat import chat_pb2_grpc
from leapfrogai_api.types.completion import completion_pb2_grpc
from leapfrogai_api.types.embeddings import embeddings_pb2_grpc
from leapfrogai_api.types.name import name_pb2_grpc
