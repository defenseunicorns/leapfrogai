...
from leapfrogai_api.types.chat import chat_pb2 as leapfrogai__api_dot_types_dot_chat_dot_chat__pb2
...
class ChatCompletionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ChatComplete = channel.unary_unary(
                ...
                request_serializer=leapfrogai__api_dot_types_dot_chat_dot_chat__pb2.ChatCompletionRequest.SerializeToString,
                response_deserializer=leapfrogai__api_dot_types_dot_chat_dot_chat__pb2.ChatCompletionResponse.FromString,
                )
...
def add_ChatCompletionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ChatComplete': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=leapfrogai__api_dot_types_dot_chat_dot_chat__pb2.ChatCompletionRequest.FromString,
                    response_serializer=leapfrogai__api_dot_types_dot_chat_dot_chat__pb2.ChatCompletionResponse.SerializeToString,
            ),
    }
...
class ChatCompletionService(object):
    ...
    def ChatComplete(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/chat.ChatCompletionService/ChatComplete',
            leapfrogai__api_dot_types_dot_chat_dot_chat__pb2.ChatCompletionRequest.SerializeToString,
            leapfrogai__api_dot_types_dot_chat_dot_chat__pb2.ChatCompletionResponse.FromString,
