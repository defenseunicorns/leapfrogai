...
async def retrieve_thread(thread_id: str,
                          auth_creds: Annotated[HTTPAuthorizationCredentials, Depends(security)]) -> Thread:
    """Retrieve a thread."""
    # TODO: Implement this function
    raise HTTPException(status_code=501, detail="Not implemented")
...
async def modify_thread(thread_id: str,
                        auth_creds: Annotated[HTTPAuthorizationCredentials, Depends(security)]) -> Thread:
    """Modify a thread."""
    # TODO: Implement this function
    raise HTTPException(status_code=501, detail="Not implemented")
...
async def delete_thread(thread_id: str,
                        auth_creds: Annotated[HTTPAuthorizationCredentials, Depends(security)]) -> ThreadDeleted:
    """Delete a thread."""
    # TODO: Implement this function
    raise HTTPException(status_code=501, detail="Not implemented")
...
async def create_message(thread_id: str,
                         auth_creds: Annotated[HTTPAuthorizationCredentials, Depends(security)]) -> Message:
    """Create a message."""
    # TODO: Implement this function
    raise HTTPException(status_code=501, detail="Not implemented")
...
async def list_messages(thread_id: str,
                        auth_creds: Annotated[HTTPAuthorizationCredentials, Depends(security)]) -> list[Message]:
...
async def modify_message(thread_id: str, message_id: str,
                         auth_creds: Annotated[HTTPAuthorizationCredentials, Depends(security)]) -> Message:
    """Modify a message."""
    # TODO: Implement this function
    raise HTTPException(status_code=501, detail="Not implemented")
...
async def create_run(thread_id: str,
                     auth_creds: Annotated[HTTPAuthorizationCredentials, Depends(security)]) -> Run:
    """Create a run."""
    # TODO: Implement this function
    raise HTTPException(status_code=501, detail="Not implemented")
...
@router.post("/runs")
async def create_thread_and_run(assistant_id: str,
                                auth_creds: Annotated[HTTPAuthorizationCredentials, Depends(security)]) -> Run:
...
async def list_runs(thread_id: str,
                    auth_creds: Annotated[HTTPAuthorizationCredentials, Depends(security)]) -> list[Run]:
...
async def list_run_steps(thread_id: str, run_id: str,
                         auth_creds: Annotated[HTTPAuthorizationCredentials, Depends(security)]) -> list[RunStep]:
...
async def retrieve_run_step(thread_id: str, run_id: str, step_id: str,
                            auth_creds: Annotated[HTTPAuthorizationCredentials, Depends(security)]) -> RunStep:
    """Retrieve a step."""
    # TODO: Implement this function
    raise HTTPException(status_code=501, detail="Not implemented")
