...
from leapfrogai.audio import audio_pb2 as leapfrogai_dot_audio_dot_audio__pb2
...
class AudioStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Translate = channel.stream_unary(
                ...
                request_serializer=leapfrogai_dot_audio_dot_audio__pb2.AudioRequest.SerializeToString,
                response_deserializer=leapfrogai_dot_audio_dot_audio__pb2.AudioResponse.FromString,
                )
...
def add_AudioServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Translate': grpc.stream_unary_rpc_method_handler(
                    servicer.Translate,
                    request_deserializer=leapfrogai_dot_audio_dot_audio__pb2.AudioRequest.FromString,
                    response_serializer=leapfrogai_dot_audio_dot_audio__pb2.AudioResponse.SerializeToString,
            ),
...
class Audio(object):
    ...
    def Translate(request_iterator,
        ...
        return grpc.experimental.stream_unary(request_iterator, target, '/audio.Audio/Translate',
            leapfrogai_dot_audio_dot_audio__pb2.AudioRequest.SerializeToString,
            leapfrogai_dot_audio_dot_audio__pb2.AudioResponse.FromString,
