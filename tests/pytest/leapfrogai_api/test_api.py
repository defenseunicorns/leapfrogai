...
from leapfrogai_api.routers.supabase_session import init_supabase_client_with_jwt
...
def dummy_auth_middleware():
    app.dependency_overrides[init_supabase_client_with_jwt] = mock_init_supabase_client
