...
from leapfrogai_api.routers.supabase_session import init_supabase_client_with_jwt, init_supabase_client_with_api_key
...
def dummy_auth_middleware():
    app.dependency_overrides[init_supabase_client_with_jwt, init_supabase_client_with_api_key] = mock_init_supabase_client
